...
use aumate_infrastructure::adapters::{
    ClipboardAdapter, HotkeyListenerAdapter, ImageProcessingAdapter, PageManagementAdapter,
    ScreenCaptureAdapter, ScrollCaptureAdapter, UIAutomationAdapter, WindowManagementAdapter,
};
use std::sync::Arc;
