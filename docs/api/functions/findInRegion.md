...
[Tego Bot API Documentation](../globals.md) / findInRegion

# Function: findInRegion()

> **findInRegion**(`template`, `x`, `y`, `width`, `height`, `config?`): `Promise`\<[`MatchResult`](../interfaces/MatchResult.md) \| `null`\>

Defined in: [botjs/src/image-match.ts:294](https://github.com/tegojs/bot/blob/0a4decde0a125e094c5c44e05c0e4efe6c9e05df/packages/botjs/src/image-match.ts#L294)
